...
import com.andrewkingmarshall.beachbuddy.database.RealmListener
...
fun <T> RealmQuery<T>.equalToValue(fieldName: String, value: String): RealmQuery<T> = equalTo(fieldName, value)
